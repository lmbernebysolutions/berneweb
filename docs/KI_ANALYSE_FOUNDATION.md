...
9. **08 – Mini-FAQ** – FaqAccordion (HOME_MINI_FAQ)
10. **SchweinDivider**
11. **CtaSection**

### Über uns (`app/ueber-uns/page.tsx`)
1. **Hero** – „Zwei Macher. Ein Ziel.“
2. **TrustBar** – UEBER_UNS_STATS (ohne Section-Wrapper)
3. **02 – Unser Versprechen** – Zitat-Karte (IconQuote)
4. **03 – Das Team** – TeamSection (TEAM, variant="navy")
5. **04 – Vision & Mission** – zwei Karten (Vision / Mission)
6. **05 – Timeline** – „Von der Idee zum Unternehmen“ (TIMELINE)
7. **06 – Werte** – FeatureGrid (VALUES, cols=4, light)
8. **07 – Warum Berneby** – 4 Karten nummeriert 01–04 (WARUM_BERNEBY)
9. **08 – FAQ** – FaqAccordion (FAQ_ITEMS gefiltert)
10. **SchweinDivider**
11. **CtaSection**
...
11. **10 – FAQ** – FaqAccordion (FAQ_ITEMS)
12. **SchweinDivider**
13. **CtaSection**

### Tech Solutions (`app/(marketing)/tech/page.tsx`)
1. **Hero** – Tech-spezifisch
2. **02 – Mission** – MissionSection („Kein Bullshit. Nur Lösungen.“)
3. **03 – Services** – ServiceTabs / Katalog (id="leistungen"), CRAFT_MODULES-ähnliche Karten mit Schweinchen im Hintergrund
4. **04 – Retainer** – 10er Karte / Hausmeister-Angebot
5. **05 – Testimonials** – TestimonialGrid
6. **06 – Prozess** – ProcessSteps
7. **07 – Technologien** – TECH_STACK
8. **08 – Referenzen** – Case Studies / Referenzen
9. **09 – FAQ** – FaqAccordion
10. **SchweinDivider**
11. **CtaSection**
...
5. **02 – FAQ** – „Häufige Fragen zum Erstgespräch“
6. **SchweinDivider**
7. Schema.org Script
...
| **SchweinDivider** | `components/ui/schweinchen-divider.tsx` | Organische Wellenform (SVG) zwischen letzter Sektion und CTA |
...
- **„Wellen zwischen Sektion und CTA“** → SchweinDivider.
...
- **docs/SEKTIONEN_VORSCHLAEGE.md** – Inhaltliche Sektionsvorschläge (nicht zwingend umgesetzt).

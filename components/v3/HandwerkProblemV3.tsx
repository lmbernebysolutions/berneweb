...
// V3 CHANGES (vs HandwerkProblemWithRevealSection):
// - STATUS_OFFLINE Badge entfernen
// - TechCorners entfernen
// - "PROBLEM: Hoch" → "— Hoch" (kein HUD-Vokabular)
...
export function HandwerkProblemV3() {
  ...
  return (
    ...
    >
      ...
      >
        <p className="text-sm sm:text-base font-bold uppercase tracking-[0.2em] text-white/70">
          Unsere Lösungen
        </p>
      </div>
    </div>

...
// V3 CHANGES (vs ProblemToSolutionScrollSectionV2):
// - Static Glow entfernen → nur hover:
// - Heading drop-shadow entfernen
// - Grid-Overlay Cyan → white/4
...
export function ProblemToSolutionScrollSectionV3() {
    ...
    <div ref={sectionRef} className="relative min-h-[80vh] md:hidden">
      <div
        className={cn(
          ...
          progress > 0.5
            ? "border-2 border-brand-cyan/30 bg-brand-cyan/5"
            // V3: kein static shadow
            : "border-2 border-white/5 bg-black/30"
        )}
      >
        {/* TechCorners: nur im Solution-State */}
        {progress > 0.5 && (
          <TechCorners
            pattern="all"
            variant="cyan"

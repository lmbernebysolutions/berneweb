...
/* Brand: Navy #283569, Cyan #03f9f9 – explizite Hex-Werte, da react-cookie-manager eigenes Tailwind nutzt und keine Projekt-CSS-Variablen kennt */
const cookieClassNames = {
  bannerContainer:
    "fixed bottom-0 left-0 right-0 z-[100] border-t border-[#03f9f9]/30 bg-[#283569] shadow-lg font-sans",
  bannerContent:
  ...
  acceptButton:
    "inline-flex items-center justify-center rounded-md px-4 py-2.5 text-sm font-semibold bg-[#03f9f9] text-[#283569] hover:opacity-90 transition-opacity focus:outline-none focus:ring-2 focus:ring-[#03f9f9] focus:ring-offset-2 focus:ring-offset-[#283569]",
  declineButton:
    "inline-flex items-center justify-center rounded-md px-4 py-2.5 text-sm font-medium border border-white/30 text-white/90 hover:bg-white/10 transition-colors focus:outline-none focus:ring-2 focus:ring-[#03f9f9] focus:ring-offset-2 focus:ring-offset-[#283569]",
  manageButton:
    "inline-flex items-center justify-center rounded-md px-4 py-2.5 text-sm font-medium text-[#03f9f9] hover:underline focus:outline-none focus:ring-2 focus:ring-[#03f9f9] focus:ring-offset-2 focus:ring-offset-[#283569]",
  privacyPolicyLink: "text-[#03f9f9] underline hover:no-underline",

  popupContainer:
    "fixed inset-0 z-[100] flex items-center justify-center p-4 bg-black/50 font-sans",
  popupContent:
    "rounded-lg border border-[#03f9f9]/30 bg-[#283569] p-6 shadow-xl max-w-md w-full",
  ...
  manageCookieToggle:
    "relative inline-flex h-6 w-11 shrink-0 cursor-pointer rounded-full border-2 border-white/30 bg-white/10 transition-colors focus:outline-none focus:ring-2 focus:ring-[#03f9f9] focus:ring-offset-2 focus:ring-offset-[#283569] data-[state=checked]:bg-[#03f9f9] data-[state=checked]:border-[#03f9f9]",
  manageCookieToggleChecked: "",
  manageCancelButton:
    "rounded-md px-4 py-2 text-sm font-medium border border-white/30 text-white/90 hover:bg-white/10",
  manageSaveButton:
    "rounded-md px-4 py-2 text-sm font-semibold bg-[#03f9f9] text-[#283569] hover:opacity-90",

  floatingButton:
    "fixed bottom-6 left-6 z-50 flex h-12 w-12 items-center justify-center rounded-full border border-[#03f9f9]/30 bg-[#283569] text-white shadow-lg hover:bg-white/10 transition-colors focus:outline-none focus:ring-2 focus:ring-[#03f9f9]",
